...
const ShortListedCandidatePage = () => {
    ...
    return (
        <Navbar active={"shortlisted"} navShow={navShown}>
            <div className="flex w-full bg-cyan-900 items-center fixed z-20">
                ...
                <h1 className="text-center text-white py-4 w-full font-bold">Shortlisted candidates</h1>
            </div>
...
export default ShortListedCandidatePage